...
const InstagramQr = () => {
  ...
  // Initialize the state for username and user_id
  ...
  // Handle username change and update the instagramData state
  ...
  <div className='flex-group'>
    <div className='wifi-container'>
      ...
      <div className="flex-input">
        ...
        <label className="form-label">Enter Instagram Username:</label>
        <input 
          type="text" 
      ...
      <div className="qr-deigningig-component">
        ...
        <div className='qr-display-container-fix-it'>
          ...
          >
            <QRCode
              value={`https://www.instagram.com/${instagramData.username}/`}
          ...
          {isDownload === false ? (
            <button className="button-57" style={{ width: '100%' }} onClick={() => {
              handleSubmit("localinstagram", instagramData); // Pass the entire wifiData including qrLocalData
            }} role="button">
