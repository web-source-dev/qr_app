          ...
          <div key={business._id} className="business-item">
            <div className="small-row-container-for-qr-code-display">
              ...
              <h3>{index + 1}.</h3> 
                ...
                <h3 className="type-of-qr">Menu</h3> 
              ...
              <div className="action-btns-for-qr-active-del-edit">
                ...
                <button className="btn-18" onClick={() => handleDeleteClick('shopmenu', business._id)}>
                  <span> Delete</span>
                </button>
...
export default ShopMenuDataList;
