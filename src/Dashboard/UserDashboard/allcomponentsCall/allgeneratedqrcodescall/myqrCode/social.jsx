...
const SocialDataList = () => {
  const { setBusinessData, handleDeleteClick,formatDate, handleActiveClick, setFilteredData, setLoading, setError, businessData, filteredData, loading, error, handleSubmit, qrvalueide, handleUpdate, buyCredits, fetchBusinessData, handleDownload, handleBuyCredits, isPopupOpen, handleClosePopup } = useFormContext()
          ...
          <div key={business._id} className="business-item">
            <div className="small-row-container-for-qr-code-display">
              ...
              <h3>{index + 1}.</h3> 
                ...
                <h3 className="type-of-qr">Social</h3>
              ...
              <div className="action-btns-for-qr-active-del-edit">
                ...
                <button className="btn-18" onClick={() => handleDeleteClick('facebook', business._id)}>
                  <span> Delete</span>
                </button>
