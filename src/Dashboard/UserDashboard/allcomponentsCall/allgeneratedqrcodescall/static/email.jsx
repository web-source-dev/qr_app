...
const EmailDataList = () => {
  const { handleDownload, fetchData,formatDate, handleDelete, fetchedData } = useGlobalLocal();
        ...
        fetchedData.map((business, index) => (
          <div key={business._id} className="business-item">
            <div className="small-row-container-for-qr-code-display">
              ...
              <h3 className="type-of-qr">Email</h3> 
              ...
              <div className="action-btns-for-qr-active-del-edit">
                ...
                <button
                  className="btn-18"
                  onClick={() => handleDelete('email', business._id)}
                >
                  <span>Delete</span>
                </button>
              </div>
