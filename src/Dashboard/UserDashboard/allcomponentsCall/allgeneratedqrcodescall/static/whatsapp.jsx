...
const WhatsappDataList = () => {
  const { handleDownload, fetchData, handleDelete, fetchedData,formatDate } = useGlobalLocal();
          ...
          <div key={business._id} className="business-item">
            <div className="small-row-container-for-qr-code-display">
              ...
              <div className="text-for-each-qr-name-or-short-title">
                <h3 className="type-of-qr">Whatsapp</h3> 
                  {business.qrDesign?.logodText || `Untitled`}
              ...
              <div className="action-btns-for-qr-active-del-edit">
                ...
                <button
                  className="btn-18"
                  onClick={() => handleDelete('whatsapqr', business._id)}
                >
                  <span>Delete</span>
                </button>
              </div>
...
export default WhatsappDataList;
